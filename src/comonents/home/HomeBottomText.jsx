...
const HomeBottomText = () => {
  ...
  return (
    ...
    <div className='font-[font2] flex items-center justify-center gap-2 '>
      ...
      <div className='lg:border-5 border-3 hover:border-[#0d2bd4] hover:text-[#0d2bd4] lg:h-44 flex items-center px-3 pt-1 lg:px-14 border-amber-900 rounded-full uppercase'>
